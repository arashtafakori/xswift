...
namespace XSwift.Mvc
{
    ...
    public class HttpService
    {
        ...
        /// <summary>
        /// Sends an HTTP request asynchronously and returns the response as an <see cref="XHttpResponse"/>.
        /// </summary>
        /// <param name="httpRequest">The HTTP request details.</param>
        /// <returns>An <see cref="XHttpResponse"/> representing the HTTP response.</returns>
        public async Task<XHttpResponse> SendAsync(XHttpRequest httpRequest)
        {
            ...
            return new XHttpResponse(httpResponseMessage);
        }
        ...
        public async Task<TResult> SendAndReadAsResultAsync<TResult>(XHttpRequest httpRequest)
        {
