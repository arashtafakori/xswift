...
namespace XSwift.Mvc
{
    ...
    public class XHttpResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XHttpResponse"/> class with the specified HttpResponseMessage.
        /// </summary>
        /// <param name="httpResponseMessage">The HttpResponseMessage associated with the HTTP response.</param>
        public XHttpResponse(HttpResponseMessage httpResponseMessage)
        {
